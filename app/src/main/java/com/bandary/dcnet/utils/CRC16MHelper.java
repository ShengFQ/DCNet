...
public class CRC16MHelper {
	...
	public void update(byte[] puchMsg, int usDataLen) {
		...
		value = (((uchCRCHi) << 8 | ((uchCRCLo) & 0xff))) & 0xffff;
	...
	public static byte[] getSendBuf(String toSend){
		...
		CRC16MHelper crc16 = new CRC16MHelper();
	...
	/*public static void main(String[] args) {
		...
		byte[] sbuf = CRC16MHelper.getSendBuf("0106000300020113");
		System.out.println(CRC16MHelper.getBufHexStr(sbuf));
	}*/
